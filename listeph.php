...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="7" class="text">
        ...
        <tr>
          <td><form name="stat" method="post" target="new" action="expphoto.php" >
    ...
    <tr>
      ...
      <td  ><div align="center"><strong>Du</strong></div></td>
      <td  ><div align="center"><strong>Saison</strong></div></td>
    </tr>
                <tr>
      <td align="left"><input name="datau" type="date" id="ord" tabindex="7" size="25"></td>
      <td align="left"><input name="datdu" type="date" id="ord" tabindex="7" size="25"></td>
    <td align="center">
